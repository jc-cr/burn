use crate::{
    ...
    node::{
        ...
        dequantize_linear::dequantize_linear_update_output,
        quantize_linear::quantize_linear_update_output,
...
pub fn rank_inference(node: &mut Node) {
    ...
    match node.node_type {
        ...
        NodeType::DequantizeLinear => dequantize_linear_update_output(node),
        ...
        NodeType::QuantizeLinear => quantize_linear_update_output(node),
